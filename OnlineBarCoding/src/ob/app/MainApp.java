...
import ob.app.view.ReBarCodeingController;
...
public class MainApp extends Application {
	...
	public void addReBarCoding() {
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(MainApp.class.getResource("view/ReBarCodeing.fxml"));
			AnchorPane buttonBar = (AnchorPane) loader.load();
			rootLayout.setCenter(buttonBar);

			ReBarCodeingController controller = loader.getController();
			controller.setMainApp(this);
			//controller.setBean();
		} catch (Exception e) {
			System.out.println(e);
